  ...
  return (
    <div >
      <header className='flex p-4 justify-between'>
        <a href = "" className="flex items-center gap-1"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-8 h-65 -rotate-90">
...
<div className='flex gap-2 border border-gray-300 rounded-full py-2 px-5 shadow-md shadow-gray-300 font-bold'>
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 15.75l-2.489-2.489m0 0a3.375 3.375 0 10-4.773-4.773 3.375 3.375 0 004.774 4.774zM21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
    ...
    <div className='flex items-center gap-2 border border-gray-300 rounded-full py-2 px-5 shadow-md font-bold'>
